...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden grid place-items-center aspect-[9/16] border border-[#27272a] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
