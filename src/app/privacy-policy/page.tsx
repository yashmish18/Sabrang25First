...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <h3 className="text-xl font-semibold mb-2">What is a Cookie?</h3>
      ...
      <h3 className="text-xl font-semibold mb-2">Functional</h3>
      ...
      <p className="mb-10 leading-relaxed">References to JK LAKSHMIPAT UNIVERSITY on this page include its authorized representatives and affiliates acting on its behalf in connection with the operation of this site.</p>
